...
export default function MobileAppShowcase() {
  ...
  function useAutoDismiss(isOpen: boolean, onClose: () => void, delay: number) {
    React.useEffect(() => {
      if (isOpen) {
  ...
  useAutoDismiss(isAlertOpen, () => setIsAlertOpen(false), 3000);
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            onClick={() => handleComingSoon("iOS App")}
            className="group inline-flex items-center justify-center gap-2 bg-orange-600 text-white px-8 py-4 rounded-xl font-medium hover:bg-orange-700 transition-colors"
          >
            <AppleIcon className="h-5 w-5" />
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="flex justify-center gap-6">
          <motion.button
            ...
            onClick={() => handleComingSoon("Facebook Page")}
          ...
          <motion.button
            whileHover={{ scale: 1.1 }}
            onClick={() => handleComingSoon("Instagram Page")}
            className="p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
          >
            <svg
              className="w-6 h-6 text-gray-600 dark:text-gray-400"
      ...
      <footer className="bg-white dark:bg-gray-800 py-12">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-8">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <motion.button
                  ...
                  className="px-4 py-2 text-gray-600 dark:text-gray-400 hover:text-orange-600 dark:hover:text-orange-400"
                >
                  Contact
                </motion.button>
                <motion.button
            ...
            <div className="text-center text-sm text-gray-600 dark:text-gray-400 border-t border-gray-200 dark:border-gray-700 pt-8">
              <p>
